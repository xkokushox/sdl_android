...
public class AirbagStatus extends RPCStruct {
    ...
    public void setDriverAirbagDeployed(VehicleDataEventStatus driverAirbagDeployed) {
        if (driverAirbagDeployed != null) {
            store.put(Constants.KEY_DRIVER_AIRBAG_DEPLOYED, driverAirbagDeployed);
        } else {
            store.remove(Constants.KEY_DRIVER_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getDriverAirbagDeployed() {
        Object obj = store.get(Constants.KEY_DRIVER_AIRBAG_DEPLOYED);
    ...
    public void setDriverSideAirbagDeployed(VehicleDataEventStatus driverSideAirbagDeployed) {
        if (driverSideAirbagDeployed != null) {
            store.put(Constants.KEY_DRIVER_SIDE_AIRBAG_DEPLOYED, driverSideAirbagDeployed);
        } else {
            store.remove(Constants.KEY_DRIVER_SIDE_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getDriverSideAirbagDeployed() {
        Object obj = store.get(Constants.KEY_DRIVER_SIDE_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setDriverCurtainAirbagDeployed(VehicleDataEventStatus driverCurtainAirbagDeployed) {
        if (driverCurtainAirbagDeployed != null) {
            store.put(Constants.KEY_DRIVER_CURTAIN_AIRBAG_DEPLOYED, driverCurtainAirbagDeployed);
        } else {
            store.remove(Constants.KEY_DRIVER_CURTAIN_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getDriverCurtainAirbagDeployed() {
        Object obj = store.get(Constants.KEY_DRIVER_CURTAIN_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setPassengerAirbagDeployed(VehicleDataEventStatus passengerAirbagDeployed) {
        if (passengerAirbagDeployed != null) {
            store.put(Constants.KEY_PASSENGER_AIRBAG_DEPLOYED, passengerAirbagDeployed);
        } else {
            store.remove(Constants.KEY_PASSENGER_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getPassengerAirbagDeployed() {
        Object obj = store.get(Constants.KEY_PASSENGER_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setPassengerCurtainAirbagDeployed(VehicleDataEventStatus passengerCurtainAirbagDeployed) {
        if (passengerCurtainAirbagDeployed != null) {
            store.put(Constants.KEY_PASSENGER_CURTAIN_AIRBAG_DEPLOYED, passengerCurtainAirbagDeployed);
        } else {
            store.remove(Constants.KEY_PASSENGER_CURTAIN_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getPassengerCurtainAirbagDeployed() {
        Object obj = store.get(Constants.KEY_PASSENGER_CURTAIN_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setDriverKneeAirbagDeployed(VehicleDataEventStatus driverKneeAirbagDeployed) {
        if (driverKneeAirbagDeployed != null) {
            store.put(Constants.KEY_DRIVER_KNEE_AIRBAG_DEPLOYED, driverKneeAirbagDeployed);
        } else {
            store.remove(Constants.KEY_DRIVER_KNEE_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getDriverKneeAirbagDeployed() {
        Object obj = store.get(Constants.KEY_DRIVER_KNEE_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setPassengerSideAirbagDeployed(VehicleDataEventStatus passengerSideAirbagDeployed) {
        if (passengerSideAirbagDeployed != null) {
            store.put(Constants.KEY_PASSENGER_SIDE_AIRBAG_DEPLOYED, passengerSideAirbagDeployed);
        } else {
            store.remove(Constants.KEY_PASSENGER_SIDE_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getPassengerSideAirbagDeployed() {
        Object obj = store.get(Constants.KEY_PASSENGER_SIDE_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
    ...
    public void setPassengerKneeAirbagDeployed(VehicleDataEventStatus passengerKneeAirbagDeployed) {
        if (passengerKneeAirbagDeployed != null) {
            store.put(Constants.KEY_PASSENGER_KNEE_AIRBAG_DEPLOYED, passengerKneeAirbagDeployed);
        } else {
            store.remove(Constants.KEY_PASSENGER_KNEE_AIRBAG_DEPLOYED);
        }
    }
    public VehicleDataEventStatus getPassengerKneeAirbagDeployed() {
        Object obj = store.get(Constants.KEY_PASSENGER_KNEE_AIRBAG_DEPLOYED);
        if (obj instanceof VehicleDataEventStatus) {
            return (VehicleDataEventStatus) obj;
        } else if (obj instanceof String) {
            return VehicleDataEventStatus.valueForString((String) obj);
